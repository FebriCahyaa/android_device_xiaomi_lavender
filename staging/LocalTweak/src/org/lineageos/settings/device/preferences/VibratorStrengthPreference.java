...
import org.lineageos.settings.device.BootReceiver;
...
public class VibratorStrengthPreference extends CustomSeekBarPreference {
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(LocalTweaks.KEY_VIBSTRENGTH, String.valueOf(mDefVal));
    ...
    private void saveValue(String newValue) {
        ...
        editor.putString(LocalTweaks.KEY_VIBSTRENGTH, newValue);
        editor.apply();
