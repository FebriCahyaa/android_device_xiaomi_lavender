...
import org.lineageos.settings.device.ambient.SensorsDozeService;
...
public class BootReceiver extends BroadcastReceiver implements Utils {
    ...
    if(!mSetupRunning) {
        ...
        FileUtils.setValue(LocalTweaks.BACKLIGHT_DIMMER_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_BACKLIGHT_DIMMER, 0));
        ...
        FileUtils.setValue(LocalTweaks.TORCH_1_BRIGHTNESS_PATH,
                Settings.Secure.getInt(context.getContentResolver(),
                        LocalTweaks.KEY_WHITE_TORCH_BRIGHTNESS, 100));
        FileUtils.setValue(LocalTweaks.TORCH_2_BRIGHTNESS_PATH,
                Settings.Secure.getInt(context.getContentResolver(),
                        LocalTweaks.KEY_YELLOW_TORCH_BRIGHTNESS, 100));
        FileUtils.setValue(LocalTweaks.MSM_THERMAL_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PERF_MSM_THERMAL, 0));
        FileUtils.setValue(LocalTweaks.CORE_CONTROL_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PERF_CORE_CONTROL, 0));
        FileUtils.setValue(LocalTweaks.VDD_RESTRICTION_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PERF_VDD_RESTRICTION, 0));
        int gain = Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_HEADPHONE_GAIN, 4);
        FileUtils.setValue(LocalTweaks.HEADPHONE_GAIN_PATH, gain + " " + gain);
        FileUtils.setValue(LocalTweaks.MICROPHONE_GAIN_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_MICROPHONE_GAIN, 0));
        FileUtils.setValue(LocalTweaks.EARPIECE_GAIN_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_EARPIECE_GAIN, 0));
        FileUtils.setValue(LocalTweaks.SPEAKER_GAIN_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_SPEAKER_GAIN, 0));
        FileUtils.setValue(LocalTweaks.HIGH_AUDIO_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.HIGH_PERF_AUDIO, 0));
        FileUtils.setValue(LocalTweaks.USB_FASTCHARGE_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_USB_FASTCHARGE, 0));
        FileUtils.setValue(LocalTweaks.MSM_TOUCHBOOST_PATH, Settings.Secure.getInt(context.getContentResolver(),
                LocalTweaks.PREF_MSM_TOUCHBOOST, 0));
       ...
       // Ambient
        ...
        boolean enabled = sharedPrefs.getBoolean(LocalTweaks.PREF_KEY_FPS_INFO, false);
        if (enabled) {
