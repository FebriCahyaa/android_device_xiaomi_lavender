...
public class Fastcharge implements OnPreferenceChangeListener {
    ...
    public static String getFile() {
        if (FileUtils.fileWritable(LocalTweaks.USB_FASTCHARGE_PATH)) {
            return LocalTweaks.USB_FASTCHARGE_PATH;
        }
        return null;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        switch (key) {
            case LocalTweaks.PREF_USB_FASTCHARGE:
                FileUtils.setValue(LocalTweaks.USB_FASTCHARGE_PATH, (boolean) value);
                break;
