...
public class BacklightDimmer implements OnPreferenceChangeListener {
    ...
    public static String getFile() {
        if (FileUtils.fileWritable(LocalTweaks.BACKLIGHT_DIMMER_PATH)) {
            return LocalTweaks.BACKLIGHT_DIMMER_PATH;
        }
        return null;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        switch (key) {
            case LocalTweaks.PREF_BACKLIGHT_DIMMER:
                FileUtils.setValue(LocalTweaks.BACKLIGHT_DIMMER_PATH, (boolean) value);
                break;
