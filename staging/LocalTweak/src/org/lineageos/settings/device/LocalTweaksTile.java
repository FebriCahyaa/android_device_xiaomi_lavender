...
import org.lineageos.settings.device.LocalTweaksActivity;

public class LocalTweaksTile extends TileService {

    @Override
    public void onClick() {
        try {
            Intent intent = new Intent(this, LocalTweaksActivity.class);
