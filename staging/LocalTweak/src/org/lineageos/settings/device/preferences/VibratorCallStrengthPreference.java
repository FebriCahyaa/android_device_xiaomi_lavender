...
public class VibratorCallStrengthPreference extends Preference implements
	...
	private void setValue(String newValue, boolean withFeedback) {
        ...
        editor.putString(LocalTweaks.KEY_CALL_VIBSTRENGTH, newValue);
        editor.commit();
	}
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(LocalTweaks.KEY_CALL_VIBSTRENGTH, "2726");
