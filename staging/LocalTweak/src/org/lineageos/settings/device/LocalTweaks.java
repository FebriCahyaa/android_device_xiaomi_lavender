...
import org.lineageos.settings.device.ambient.AmbientGesturePreferenceActivity;
...
import org.lineageos.settings.device.Fastcharge;
import org.lineageos.settings.device.Touchboost;

public class LocalTweaks extends PreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    private static final String TAG = "LocalTweaks";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.preferences_local_tweaks, rootKey);
